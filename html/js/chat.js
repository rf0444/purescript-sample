...
var Lib_MqttClient = require("Lib.MqttClient");
...
},{"Chat.State":5,"Lib.MqttClient":20}],2:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
...
},{"Chat.Action":1,"Chat.Render":4,"Chat.State":5,"Chat.Update":6,"Control.Monad.Eff":12,"DOM":15,"Prelude":22,"Thermite":35,"Thermite.Action":23}],3:[function(require,module,exports){
/* global exports */
"use strict";
...
var userInput = function (ctx) {
    var nameInput = function (event) {
        return new Chat_Action.ConnectionFormInput(function (form) {
            var _10 = {};
            for (var _11 in form) {
                if (form.hasOwnProperty(_11)) {
                    _10[_11] = form[_11];
                };
            };
            _10.name = $foreign.eventTargetValue(event);
            return _10;
        });
    };
    return Thermite_Html_Elements.div(Thermite_Html_Attributes_Unsafe.style({
        ...
        display: "block", 
        width: "100%"
    }))(Thermite_Events.onClick(ctx)(function (_0) {
    ...
    return function (s) {
        var postInput = function (event) {
            return new Chat_Action.PostFormInput(function (form) {
                var _13 = {};
                for (var _14 in form) {
                    if (form.hasOwnProperty(_14)) {
                        _13[_14] = form[_14];
                    };
                };
                _13.content = $foreign.eventTargetValue(event);
                return _13;
            });
        };
...
var content = function (ctx) {
    var children = function (_3) {
        ...
        if (_3 instanceof Chat_State.Connected) {
            ...
            })))([ showUser(_3.value0.name) ]), Thermite_Html_Elements.div(Prelude["<>"](Thermite_Types.semigroupAttr)(Thermite_Html_Attributes.className("row"))(Thermite_Html_Attributes_Unsafe.style({
                padding: "10px"
            })))([ postForm(ctx)(_3.value0) ]), Thermite_Html_Elements.div(Prelude["<>"](Thermite_Types.semigroupAttr)(Thermite_Html_Attributes.className("row"))(Thermite_Html_Attributes_Unsafe.style({
                padding: "10px"
            })))([ posts(_3.value0.posts) ]) ];
        };
        throw new Error("Failed pattern match at C:\\Users\\rf\\Downloads\\purescript-sample\\psc\\src\\Chat\\Render.purs line 38, column 5 - line 39, column 5: " + [ _3.constructor.name ]);
    };
...
},{"./foreign":3,"Chat.Action":1,"Chat.State":5,"Prelude":22,"Thermite":35,"Thermite.Events":24,"Thermite.Html":29,"Thermite.Html.Attributes":27,"Thermite.Html.Attributes.Unsafe":26,"Thermite.Html.Elements":28,"Thermite.Types":33}],5:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
...
var update = function (_4) {
    return function (_5) {
        if (_4 instanceof Chat_Action.ConnectionFormInput && _5 instanceof Chat_State.NotConnected) {
            var next = new Chat_State.NotConnected((function () {
                var _13 = {};
                for (var _14 in _5.value0) {
                    if (_5.value0.hasOwnProperty(_14)) {
                        _13[_14] = _5.value0[_14];
                    };
                };
                _13.form = _4.value0(_5.value0.form);
                return _13;
            })());
            return next;
        };
        if (_4 instanceof Chat_Action.Connect && _5 instanceof Chat_State.NotConnected) {
            var next = function (_6) {
                if (_6 === "") {
                    return _5;
                };
            ...
            return next(_5.value0.form.name);
        };
        if (_4 instanceof Chat_Action.ResponseError && _5 instanceof Chat_State.Connecting) {
        ...
        if (_4 instanceof Chat_Action.MqttInfoResponse && _5 instanceof Chat_State.Connecting) {
            return _5;
        };
        if (_4 instanceof Chat_Action.Connected && _5 instanceof Chat_State.Connecting) {
        ...
        if (_4 instanceof Chat_Action.PostFormInput && _5 instanceof Chat_State.Connected) {
            var next = new Chat_State.Connected((function () {
                var _23 = {};
                for (var _24 in _5.value0) {
                    if (_5.value0.hasOwnProperty(_24)) {
                        _23[_24] = _5.value0[_24];
                    };
                };
                _23.form = _4.value0(_5.value0.form);
                return _23;
            })());
            return next;
        };
        if (_4 instanceof Chat_Action.Post && _5 instanceof Chat_State.Connected) {
            var next = new Chat_State.Connected((function () {
                var _27 = {};
                for (var _28 in _5.value0) {
                    if (_5.value0.hasOwnProperty(_28)) {
                        _27[_28] = _5.value0[_28];
                    };
                };
                _27.form = {
                    content: ""
        ...
        if (_4 instanceof Chat_Action.PostArrived && _5 instanceof Chat_State.Connected) {
            var next = new Chat_State.Connected((function () {
                var _31 = {};
                for (var _32 in _5.value0) {
                    if (_5.value0.hasOwnProperty(_32)) {
                        _31[_32] = _5.value0[_32];
                    };
                };
                _31.posts = Prelude["++"](Prelude.semigroupArray)([ _4.value0 ])(_5.value0.posts);
                return _31;
            })());
            return next;
        };
...
},{"Chat.Action":1,"Chat.State":5,"Prelude":22}],7:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":7,"Control.Lazy":10,"Control.Plus":14,"Prelude":22}],9:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"./foreign":11,"Prelude":22}],13:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
var Control_Plus = require("Control.Plus");
...
},{"Control.Alternative":8,"Control.Plus":14,"Prelude":22}],14:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
var Control_Alt = require("Control.Alt");
...
},{"Control.Alt":7,"Prelude":22}],15:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
module.exports = {};
...
},{"Prelude":22}],17:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":7,"Control.Alternative":8,"Control.Extend":9,"Control.MonadPlus":13,"Control.Plus":14,"Data.Functor.Invariant":16,"Data.Monoid":18,"Prelude":22}],18:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":22}],19:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":19,"Control.Monad.Eff":12,"Prelude":22,"Thermite.Action":23}],21:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":21}],23:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Monad.Eff":12,"Prelude":22,"Thermite.Internal":31,"Thermite.Types":33}],24:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":22,"Thermite.Internal":31,"Thermite.Types":33}],25:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":25,"Prelude":22,"Thermite.Internal":31,"Thermite.Types":33}],27:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":22,"Thermite.Internal":31,"Thermite.Types":33}],28:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Data_Monoid = require("Data.Monoid");
...
},{"Data.Monoid":18,"Thermite.Internal":31,"Thermite.Types":33}],29:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":22,"Thermite.Internal":31,"Thermite.Types":33}],30:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":30,"Control.Monad.Eff":12,"DOM":15,"Data.Maybe":17,"Prelude":22,"Thermite.Types":33}],32:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":32,"Data.Maybe":17,"Data.Monoid":18,"Prelude":22}],34:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":34,"Control.Monad.Eff":12,"DOM":15,"Data.Maybe":17,"Prelude":22,"Thermite.Action":23,"Thermite.Html":29,"Thermite.Internal":31,"Thermite.Types":33}],36:[function(require,module,exports){
