...
var perform = function (_4) {
    return function (action) {
        return Thermite_Action.modifyState(Chat_Update.update(action));
    };
};
var spec = Thermite.componentWillMount(Chat_Action.Increment.value)(Thermite.simpleSpec(Chat_State.initialState)(perform)(Chat_Render.render));
var main = Thermite.render(Thermite.createClass(spec))({});
module.exports = {
    main: main
};

},{"Chat.Action":1,"Chat.Render":3,"Chat.State":4,"Chat.Update":5,"Control.Monad.Eff":11,"DOM":14,"Prelude":19,"Thermite":30,"Thermite.Action":20}],3:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
...
var counter = function (value) {
    return Thermite_Html_Elements["p'"]([ Thermite_Html.text("Value: "), Thermite_Html.text(Prelude.show(Prelude.showInt)(value)) ]);
};
var buttons = function (ctx) {
    return Thermite_Html_Elements["p'"]([ Thermite_Html_Elements.button(Prelude["<>"](Thermite_Types.semigroupAttr)(Thermite_Html_Attributes.className("btn btn-default"))(Thermite_Events.onClick(ctx)(function (_0) {
        return Chat_Action.Increment.value;
    })))([ Thermite_Html.text("Increment") ]), Thermite_Html_Elements.button(Prelude["<>"](Thermite_Types.semigroupAttr)(Thermite_Html_Attributes.className("btn btn-default"))(Thermite_Events.onClick(ctx)(function (_1) {
        return Chat_Action.Decrement.value;
...
var render = function (ctx) {
    return function (s) {
        return function (_2) {
            return function (_3) {
                var html = Thermite_Html_Elements["div'"]([ navHeader, counter(s.counter), buttons(ctx) ]);
                return html;
            };
        };
    };
...
},{"Chat.Action":1,"Chat.State":4,"Prelude":19,"Thermite":30,"Thermite.Events":21,"Thermite.Html":24,"Thermite.Html.Attributes":22,"Thermite.Html.Elements":23,"Thermite.Types":28}],4:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var initialState = {
    counter: 0
...
var Chat_Action = require("Chat.Action");
var Chat_State = require("Chat.State");
var update = function (_0) {
    return function (o) {
        if (_0 instanceof Chat_Action.Increment) {
            return {
                counter: Prelude["+"](Prelude.semiringInt)(o.counter)(1)
            };
        };
        if (_0 instanceof Chat_Action.Decrement) {
            return {
                counter: Prelude["-"](Prelude.ringInt)(o.counter)(1)
            };
        };
        throw new Error("Failed pattern match at C:\\Users\\rf\\Downloads\\purescript-sample\\psc\\src\\Chat\\Update.purs line 10, column 1 - line 11, column 1: " + [ _0.constructor.name, o.constructor.name ]);
    };
};
module.exports = {
    update: update
...
},{"Chat.Action":1,"Chat.State":4,"Prelude":19}],6:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":19}],7:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":6,"Control.Lazy":9,"Control.Plus":13,"Prelude":19}],8:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":19}],9:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":19}],10:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":10,"Prelude":19}],12:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
var Control_Plus = require("Control.Plus");
...
},{"Control.Alternative":7,"Control.Plus":13,"Prelude":19}],13:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
var Control_Alt = require("Control.Alt");
...
},{"Control.Alt":6,"Prelude":19}],14:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
module.exports = {};
...
},{"Prelude":19}],16:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":6,"Control.Alternative":7,"Control.Extend":8,"Control.MonadPlus":12,"Control.Plus":13,"Data.Functor.Invariant":15,"Data.Monoid":17,"Prelude":19}],17:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":19}],18:[function(require,module,exports){
/* global exports */
"use strict";
    ...
    return new Ord(function () {
        ...
        return function (ys) {
            return $dollar(compare(ordInt)(0))($foreign.ordArrayImpl(function (x) {
                return function (y) {
                    var _174 = compare(__dict_Ord_16)(x)(y);
                    if (_174 instanceof EQ) {
                        return 0;
                    };
                    if (_174 instanceof LT) {
                        return 1;
                    };
                    if (_174 instanceof GT) {
                        return negate(ringInt)(1);
                    };
                    throw new Error("Failed pattern match at C:\\Users\\rf\\Downloads\\purescript-sample\\psc\\bower_components\\purescript-prelude\\src\\Prelude.purs line 659, column 1 - line 665, column 1: " + [ _174.constructor.name ]);
                };
            })(xs)(ys));
        };
    });
...
var $less = function (__dict_Ord_17) {
    return function (a1) {
        return function (a2) {
            var _175 = compare(__dict_Ord_17)(a1)(a2);
            if (_175 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_18) {
    return function (a1) {
        return function (a2) {
            var _176 = compare(__dict_Ord_18)(a1)(a2);
...
var $greater = function (__dict_Ord_19) {
    return function (a1) {
        return function (a2) {
            var _177 = compare(__dict_Ord_19)(a1)(a2);
            if (_177 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_20) {
    return function (a1) {
        return function (a2) {
            var _178 = compare(__dict_Ord_20)(a1)(a2);
            if (_178 instanceof LT) {
                return false;
            };
            return true;
        };
...
},{"Control.Monad.Eff":11,"Prelude":19,"Thermite.Internal":26,"Thermite.Types":28}],21:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":19,"Thermite.Internal":26,"Thermite.Types":28}],22:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":19,"Thermite.Internal":26,"Thermite.Types":28}],23:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Data_Monoid = require("Data.Monoid");
...
},{"Data.Monoid":17,"Thermite.Internal":26,"Thermite.Types":28}],24:[function(require,module,exports){
// Generated by psc version 0.7.1.0
"use strict";
var Thermite_Internal = require("Thermite.Internal");
var Prelude = require("Prelude");
...
},{"Prelude":19,"Thermite.Internal":26,"Thermite.Types":28}],25:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":25,"Control.Monad.Eff":11,"DOM":14,"Data.Maybe":16,"Prelude":19,"Thermite.Types":28}],27:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":27,"Data.Maybe":16,"Data.Monoid":17,"Prelude":19}],29:[function(require,module,exports){
/* global exports */
"use strict";
...
var displayName = function (name) {
    return function (_159) {
        var _204 = {};
        for (var _205 in _159) {
            if (_159.hasOwnProperty(_205)) {
                _204[_205] = _159[_205];
            };
        };
        _204.displayName = new Data_Maybe.Just(name);
        return _204;
    };
};
...
var componentWillMount = function (action) {
    return function (_158) {
        var _208 = {};
        for (var _209 in _158) {
            if (_158.hasOwnProperty(_209)) {
                _208[_209] = _158[_209];
            };
        };
        _208.componentWillMount = new Data_Maybe.Just(action);
        return _208;
    };
};
module.exports = {
...
},{"./foreign":29,"Control.Monad.Eff":11,"DOM":14,"Data.Maybe":16,"Prelude":19,"Thermite.Action":20,"Thermite.Html":24,"Thermite.Internal":26,"Thermite.Types":28}],31:[function(require,module,exports){
